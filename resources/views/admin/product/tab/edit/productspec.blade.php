<h5>Edit Product Specification</h5>
<hr>
 <a type="button" class=" btn btn-danger-rgba" data-toggle="modal" data-target="#bulk_delete"><i class="fa fa-trash"></i> Delete Selected</a> 
<hr>
<form action="{{ route('pro.specs.store',$products->id) }}" method="POST">
    ...
    <button class="btn btn-primary btn-md"><i class="fa fa-check-circle"></i> Add</button>
...
<!-- ------------------------- -->
<div class="modal fade" id="edit{{ $spec->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleStandardModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleStandardModalLabel">Edit : <b>{{ $spec->prokeys }}</b></h5>
