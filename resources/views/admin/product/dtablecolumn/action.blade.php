<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
      ...
      @endif
        <a class="dropdown-item" href="{{ route('add.var',$id) }}"><i class="feather icon-plus-square mr-2"></i> Add Variant</a>
        <a class="dropdown-item" href="{{url('admin/products/'.$id.'/edit')}}"><i class="feather icon-edit mr-2"></i> Edit Product</a>  
  ...
  <div class="modal-dialog modal-sm">
      <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <p>Do you really want to delete this plan <b>{{ $name[app()->getLocale()] ?? $name[config('translatable.fallback_locale')] }}</b> ? By clicking <b>YES</b> subscriptions if any related to this plans also will be deleted ! This process cannot be undone.</p>
          </div>
