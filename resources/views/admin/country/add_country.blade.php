...
@section('title','Create Add new country')
@section('body')
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label class="control-label" for="first-name">
              ...
              <input pattern="[A-Za-z]{3}" placeholder="Please enter 3 name country code ex. IND" type="text" id="first-name" name="country" value="{{ old('country') }}" class="form-control col-md-12">
