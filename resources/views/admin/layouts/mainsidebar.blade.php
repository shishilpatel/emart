        ...
        <div class="logobar">
          ...
          <div>
            ...
            <ul class="vertical-menu">
              ...
              <li id="ordersm"
                class="{{ Nav::isRoute('admin.preorders') }} {{ Nav::isResource('admin.pending.orders') }} {{ Nav::isRoute('admin.can.order') }} {{ Nav::isRoute('return.order.show') }} {{ Nav::isRoute('return.order.detail') }} {{ Nav::isRoute('return.order.index') }} {{ Nav::isResource('order') }} {{ Nav::isResource('invoice') }}">
                ...
                <ul class="vertical-submenu">
                  ...
                  <li class="{{ Nav::isRoute('admin.preorders') }}"><a href="{{route('admin.preorders')}}"></i>Pre Orders </a></li>
