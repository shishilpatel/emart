...
<div class="col-md-6">
  <div class="widgetbar">
  <button data-toggle="modal" data-target='#createState' class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>
          Add State
        </button>
  </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleStandardModalLabel">Add New State</h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('state.store') }}" method="POST">
                    ...
                    <div class="form-group">
                      <label class="text-dark">Select Country: <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                      <label class="text-dark">Enter State Name: <span class="text-danger">*</span></label>
