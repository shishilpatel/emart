        ...
        <div class="card m-b-30">
          ...
          <div class="card-body">
            <form action="{{ route('admin.affilate.update') }}" method="POST">
                ...
                <div class="form-group">
                    <label>Description:</label> <small class="text-info"> <i class="fa fa-question-circle"></i> {{ __("Some description of your affiliate system that how it gonna work?") }}</small>
              ...
              <br>
                <div class="form-group">
                    <button   class="btn btn-danger-rgba"><i class="fa fa-ban"></i> Reset</button>
