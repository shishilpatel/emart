...
<div class="col-md-6">
  ...
  <a href="{{ route('detailadvertise.index') }}" class="btn btn-primary-rgba mr-2"><i
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title">Edit Block Detail Page Advertisements</h5>
        </div>
        <div class="card-body">
          <form action="{{route('detailadvertise.update',$detail->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select required="" name="position" id="position" class="form-control select2">
                <option {{ $detail->position == 'category' ? "selected" : "" }} value="category">On Category Page
                </option>
                <option {{ $detail->position == 'prodetail' ? "selected" : "" }} value="prodetail">On Product Detail
                  Page</option>
              </select>
            </div>
            ...
            <div id="linkedPro" class="form-group {{ $detail->position == 'prodetail' ? '' : 'display-none' }}">
              ...
              <small class="text-info"><i class="fa fa-question-circle"></i> Select a product page where you want to
                display this ad.</small>
            </div>
            ...
            <div id="linkedCat" class="form-group {{ $detail->position == 'category' ? '' : 'display-none' }}">
              ...
              <small class="text-info"><i class="fa fa-question-circle"></i> Select a category page where you want to
                display this ad.</small>
            </div>
            ...
            <div class="{{ $detail->linkby == 'adsense' ? 'display-none' : "" }}" id="customad">
              ...
              <div class="form-group">
                ...
                <input value="{{ $detail->top_heading }}" name="top_heading" placeholder="Enter heading text"
            ...
            <div class="form-group">
              ...
              <input value="{{ $detail->sheading }}" name="sheading" placeholder="Enter subheading text" type="text"
            ...
            <div class="{{ $detail->show_btn == 1 ? "" : 'display-none' }}" id="buttongroup">
              <div class="form-group">
                ...
                <input value="{{ $detail->btn_text }}" placeholder="Enter button text" type="text" class="form-control"
