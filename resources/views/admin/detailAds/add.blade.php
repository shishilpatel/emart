...
@section('title','Create a Block Detail Page Advertisements ')
@section('body')
...
<div class="contentbar">
      ...
      <div class="card m-b-30">
        ...
        <div class="card-body">
          <form action="{{route('detailadvertise.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <small class="text-info"><i class="fa fa-question-circle"></i> Select a product page where you want to display this ad.</small>
          </div>
          ...
          <div id="linkedCat" class="form-group">
            ...
            <small class="text-info"><i class="fa fa-question-circle"></i> Select a category page where you want to display this ad.</small>
          </div>
  ...
  <div id="customad">
              ...
              <div id="probox" class="display-none form-group">
                ...
                <small class="text-info"><i class="fa fa-question-circle"></i> Select a product page so when user click on ad he/she will redirect to this product page </small>
              </div>
