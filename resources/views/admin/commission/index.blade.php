...
@section('title','All Commission List')
@section('body')
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title"> All Commission List</h5>
                </div>
                <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <td>
                          <form action="{{ route('commission.quick.update',$commission->id) }}" method="POST">
                              {{csrf_field()}}
                              <button type="submit" class="btn btn-rounded  {{ $commission->status==1 ? "btn-success" : "btn-danger" }}">
                           ...
                           <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                  ...
                                  <a class="dropdown-item" href="{{url('admin/commission/'.$commission->id.'/edit')}}"><i class="feather icon-edit mr-2"></i>Edit</a>
                                  
                                  <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete{{ $commission->id }}" >
                                    <i class="feather icon-delete mr-2"></i>{{ __("Delete") }}</a>
                                </a>
                                 
                              </div>
                          </div>
                          <div class="modal fade bd-example-modal-sm" id="delete{{$commission->id}}" tabindex="-1" role="dialog" aria-hidden="true">
