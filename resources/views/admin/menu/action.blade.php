...
<div class="modal-dialog modal-sm">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <p>Do you really want to delete this ? By clicking <b>YES</b> This will be permanently deleted ! This process cannot be undone.</p>
        </div>
        <div class="modal-footer">
            <form method="post" action="{{ route('menu.destroy',$id) }}" class="pull-right">
                ...
                <button type="submit" class="btn btn-danger-rgba">Yes</button>
            </form>
        </div>
    </div>
</div>
