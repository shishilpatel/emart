    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title">{{ __('Edit') }} {{ __('Advertisement') }}</h5>
        </div>
        <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <select required name="position" id="" class="form-control select2">
                  ...
                  <option {{ $adv->position == 'beforeslider' ? "selected" : "" }} value="beforeslider">Above Slider
                  </option>
                  <option {{ $adv->position == 'abovenewproduct' ? "selected" : "" }} value="abovenewproduct">Above New
                    Product Widget</option>
                  <option {{ $adv->position == 'abovetopcategory' ? "selected" : "" }} value="abovetopcategory">Above
                    Top Category</option>
                  <option {{ $adv->position == 'abovelatestblog' ? "selected" : "" }} value="abovelatestblog">Above
                    Latest Blog Widget</option>
                  <option {{ $adv->position == 'abovefeaturedproduct' ? "selected" : "" }} value="abovefeaturedproduct">
                    Above Featured Product Widget</option>
                  <option {{ $adv->position == 'afterfeaturedproduct' ? "selected" : "" }} value="afterfeaturedproduct">
                    Below Featured Product Widget</option>
                </select>

                <small class="text-info"><i class="fa fa-question-circle"></i> Select the advertisement
                  position</small>
                <br><br>
                <label>Status</label>
                <br>
              ...
              <div class="col-md-6">
                ...
                <img class="img-adv float-right" title="Two Non Equal Image Layout" src="{{ url('images/advLayout2.png') }}"
                  alt="two_non_equal_image_adv_layout">
                <input type="hidden" name="layout" value="{{ $adv->layout }}">
                @elseif($adv->layout == 'Two equal image layout')
                <img class="img-adv float-right" title="Two Equal Image Layout" src="{{ url('images/advLayout1.png') }}"
              ...
              <div class="col-md-12">
                <br>
                @if($adv->layout == 'Three Image Layout')
                <img title="Preview" id="preview1" align="center" height="100"
                  src="{{ url('images/adv/'.$adv->image1) }}" alt="" />
                <img title="Preview" id="preview2" align="center" height="100"
                  src="{{ url('images/adv/'.$adv->image2) }}" alt="" />
                <img title="Preview" id="preview3" align="center" height="100"
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Choose Image 1: <span class="required">*</span> <small class="text-info"><i
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select name="img1linkby" id="img1linkby" class="form-control select2">
                        <option {{ $adv->cat_id1 != '' ? "selected" : "" }} value="linkbycat">Link By Categories
                        </option>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Choose Image 2: <span class="required">*</span> <small class="text-info"><i
                            class="fa fa-question-circle"></i>
                          Recommended image size (438 x 240px)</small></label>
                          <div class="input-group mb-3">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select name="img2linkby" id="img2linkby" class="form-control select2">
                        <option {{ $adv->cat_id2 != '' ? "selected" : "" }} value="linkbycat">Link By Categories
                        </option>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <label>Choose Image 3: <span class="required">*</span> <small class="text-info"><i
                            class="fa fa-question-circle"></i>
                          Recommended image size (438 x 240px)</small></label>
                          <div class="input-group mb-3">
                            ...
                            <div class="custom-file">
                              ...
                              <input type="file" name="image3" class="inputfile inputfile-1" id="inputGroupFile01"
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select name="img3linkby" id="img3linkby" class="form-control select2">
                        <option {{ $adv->cat_id3 != '' ? "selected" : "" }} value="linkbycat">Link By Categories
                        </option>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="img1linkby" id="img1linkby" class="form-control select2">
                            ...
                            <option {{ $adv->pro_id1 != '' ? "selected" : "" }} value="linkbypro">Link By Product
                            </option>
                            <option {{ $adv->url1 != '' ? "selected" : "" }} value="linkbyurl">Link By Custom URL
                            </option>
                          </select>
                        </div>
                      </div>
...
<script>
  var advindexurl = "<?=route('adv.index')?>"
</script>
