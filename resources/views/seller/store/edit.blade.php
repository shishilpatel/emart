                    ...
                    <form action="{{ route('store.update',$store->id) }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col-4 placeid" style="display:{{ $store->show_google_reviews == 1 ? "block" : "none" }}">
                        <div class="form-group">
                            ...
                            <input {{ $store->show_google_reviews == 1 ? "required" : "" }} value="{{ $store->google_place_id ?? '' }}" name="google_place_id" type="text" class="pkey form-control" placeholder="{{ __("Enter your google place id key") }}">
                        </div>
                      </div>
                      ...
                      <div class="col-4 placeapi" style="display:{{ $store->show_google_reviews == 1 ? "block" : "none" }}">
                        ...
                        <div class="form-group">
                            ...
                            <input {{ $store->show_google_reviews == 1 ? "required" : "" }} value="{{ $store->google_place_api_key ?? '' }}" name="google_place_api_key" type="text" class="pkey form-control" placeholder="{{ __("Enter your google place api key") }}">
                        </div>
